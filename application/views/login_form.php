                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="p-md-5 p-2">
                                        ...
                                        <?php
                                        $attributes = array('id' => 'LoginForm', 'method' => "post", "class" => "user");
                                        ...
                                        <div class="form-group">
                                            <input type="password" autocomplete="off" class="form-control form-control-user" id="password" name="password" placeholder="Enter password...">
